...
enet_pytorch, = nn.Sequential( # Sequential, 
    LambdaMap(lambda x: x, # ConcatTable, 
        nn.Conv2d(3, 13, (3, 3), (2, 2), (1, 1), (1, 1), 1), 
        StatefulMaxPool2d((2, 2), (2, 2), (0, 0), ceil_mode=False), #SpatialMaxPooling 1, 
    ), 
    ...
    nn.Sequential( # Sequential, 
        LambdaMap(lambda x: x, # ConcatTable, 
            ...
            nn.Sequential( # Sequential, 
                ...
                StatefulMaxPool2d((2, 2), (2, 2), (0, 0), ceil_mode=False), #SpatialMaxPooling 2, 
                Padding(0, 48, 0, 0, 3), 
            ), 
        ), 
    ...
    nn.Sequential( # Sequential, 
        LambdaMap(lambda x: x, # ConcatTable, 
            ...
            nn.Sequential( # Sequential, 
                Lambda(lambda x: x), # Identity, 
                StatefulMaxPool2d((2, 2), (2, 2), (0, 0), ceil_mode=False), #SpatialMaxPooling 3, 
                Padding(0, 64, 0, 0, 3), 
            ), 
        ), 
        LambdaReduce(lambda x,y: x+y), # CAddTable, 
    ...
    nn.Sequential( # Sequential, 
        LambdaMap(lambda x: x, # ConcatTable, 
            ...
            nn.Sequential( # Sequential, 
                ...
                nn.BatchNorm2d(64, 0.001, 0.1, True), 
                StatefulMaxUnpool2d(), #SpatialMaxUnpooling 3, 
            ), 
        ), 
        LambdaReduce(lambda x,y: x+y), # CAddTable, 
        nn.PReLU(64), 
    ...
    nn.Sequential( # Sequential, 
        LambdaMap(lambda x: x, # ConcatTable, 
            ...
            nn.Sequential( # Sequential, 
                ...
                nn.Conv2d(64, 16, (1, 1), (1, 1), (0, 0), (1, 1), 1, bias=False), 
                nn.BatchNorm2d(16, 0.001, 0.1, True), 
                StatefulMaxUnpool2d(), #SpatialMaxUnpooling 2, 
            ), 
        ), 
        LambdaReduce(lambda x,y: x+y), # CAddTable, 
        nn.PReLU(16), 
